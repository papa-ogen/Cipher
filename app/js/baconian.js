...
(function ($, cipherHelper) {
	...
	var ALGORITHM = [{ "letter": "A", "code": "aaaaa" }, { "letter": "B", "code": "aaaab" }, { "letter": "C", "code": "aaaba" }, { "letter": "D", "code": "aaabb" }, { "letter": "E", "code": "aabaa" }, { "letter": "F", "code": "aabab" }, { "letter": "G", "code": "aabba" }, { "letter": "H", "code": "aabbb" }, { "letter": "I/J", "code": "abaaa" }, { "letter": "K", "code": "abaab" }, { "letter": "L", "code": "ababa" }, { "letter": "M", "code": "ababb" }, { "letter": "N", "code": "abbaa" }, { "letter": "O", "code": "abbab" }, { "letter": "P", "code": "abbba" }, { "letter": "Q", "code": "abbbb" }, { "letter": "R", "code": "baaaa" }, { "letter": "S", "code": "baaab" }, { "letter": "T", "code": "baaba" }, { "letter": "U/V", "code": "baabb" }, { "letter": "W", "code": "babaa" }, { "letter": "X", "code": "babab" }, { "letter": "Y", "code": "babba" }, { "letter": "Z", "code": "babbb" }];

	var Baconian = function Baconian(obj) {
	...
	Baconian.prototype = {
		...
		decipher: function decipher(input, objKey, objValue, decode) {
			var output = [];
